...
| Database/migrations | `db/`, `drizzle/0000` through `0014` | A protected Sites D1 has the ten `0000` base tables, but no verified migration ledger and no `0001`–`0014` operational/authorization/CMS/settings/search-index migrations | `DATABASE_NOT_PRODUCTION_VERIFIED` |
...
- D1 has only the ten base tables; migration ledger, `0001`–`0014` Yard,
