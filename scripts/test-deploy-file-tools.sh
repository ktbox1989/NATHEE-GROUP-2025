...
cp -a -- "$backup_dir" "$tampered_metadata"
...
printf 'DEPLOY_FILE_TOOLS_TEST_PASS backup=verified unknown=preserved rollback=verified tar_tamper=rejected metadata_tamper=rejected rsync=absent\n'
