...
export const motorcycleInspections = sqliteTable(
  "motorcycle_inspections",
  {
    ...
    notes: text("notes"),
    leftImageId: text("left_image_id").references(() => motorcycleImages.id, { onDelete: "restrict", onUpdate: "cascade" }),
    rightImageId: text("right_image_id").references(() => motorcycleImages.id, { onDelete: "restrict", onUpdate: "cascade" }),
    frontImageId: text("front_image_id").references(() => motorcycleImages.id, { onDelete: "restrict", onUpdate: "cascade" }),
    rearImageId: text("rear_image_id").references(() => motorcycleImages.id, { onDelete: "restrict", onUpdate: "cascade" }),
