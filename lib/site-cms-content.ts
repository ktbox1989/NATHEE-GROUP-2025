...
export const DEFAULT_SITE_CONTENT: Record<SitePageSlug, CmsPageContent> = {
  ...
  "motorcycle-transport": {
    version: 1,
    seo: { title: "ขนส่งรถจักรยานยนต์ทั่วประเทศ | NATHEE GROUP 2025", description: "บริการขนส่งรถจักรยานยนต์ทั่วประเทศ รองรับงานรายคันและงานล็อต ด้วยรถขนส่ง 4 ล้อและ 6 ล้อ ตามลักษณะงานจริง" },
    sections: [
      section("motorcycle-transport-hero", "HERO", "ขนส่งภายในประเทศ", "ขนส่งรถจักรยานยนต์ทั่วประเทศ", "รองรับรถใหม่ รถมือสอง งานรายคัน และงานล็อต โดยจัดรูปแบบรถขนส่งให้เหมาะกับจำนวนและเส้นทาง", { primaryLabel: "ขอใบเสนอราคา", primaryHref: "/quotation", secondaryLabel: "ดูผลงาน", secondaryHref: "/gallery" }),
      ...
      section("motorcycle-transport-gallery", "GALLERY", "ผลงานจริง", "ภาพงานขนส่งรถจักรยานยนต์", "แสดงเฉพาะภาพที่แอดมินอนุมัติให้เผยแพร่", { galleryLimit: 12 }),
  ...
  international: {
    version: 1,
    seo: { title: "ขนส่งรถจักรยานยนต์ต่างประเทศ | NATHEE GROUP 2025", description: "บริการเตรียมรถจักรยานยนต์ จัดเรียง ขึ้นตู้ Container และจัดเก็บหลักฐานสำหรับงานขนส่งต่างประเทศ" },
    sections: [
      section("international-hero", "HERO", "งานส่งออก", "ขนส่งรถจักรยานยนต์ต่างประเทศ", "รองรับการเตรียมรถ จัดเรียง ขึ้นตู้ Container และจัดเก็บหลักฐานตามขอบเขตงานที่ตกลง", { primaryLabel: "ขอใบเสนอราคา", primaryHref: "/quotation", secondaryLabel: "ดูงานขึ้นตู้", secondaryHref: "/container-loading" }),
      ...
      section("international-gallery", "GALLERY", "ผลงานจริง", "ภาพการเตรียมและโหลดรถ", "ไม่มีการใช้ภาพ Stock แทนผลงานบริษัท", { galleryLimit: 12 }),
  ...
  storage: {
    version: 1,
    seo: { title: "รับฝากรถและสต๊อกรถจักรยานยนต์ | NATHEE GROUP 2025", description: "บริการรับฝากรถ สต๊อกรถจักรยานยนต์และสินค้า พร้อมการรับเข้า จัดเก็บ และส่งมอบตามข้อมูลจริง" },
    sections: [
      section("storage-hero", "HERO", "ลานและคลัง", "รับฝากรถ สต๊อกรถ และสต๊อกสินค้า", "รองรับการรับเข้า จัดเก็บ และเตรียมส่งมอบ โดยประเมินพื้นที่และระยะเวลาจากงานจริง", { primaryLabel: "ขอใบเสนอราคา", primaryHref: "/quotation", secondaryLabel: "ดูผลงาน", secondaryHref: "/gallery" }),
      ...
      section("storage-gallery", "GALLERY", "พื้นที่และผลงาน", "ภาพการจัดเก็บรถจริง", "แสดงเฉพาะภาพที่ได้รับอนุญาตให้เผยแพร่", { galleryLimit: 12 }),
  ...
  "container-loading": {
    version: 1,
    seo: { title: "รับขึ้นตู้รถจักรยานยนต์และส่งออก | NATHEE GROUP 2025", description: "บริการเตรียม จัดเรียง และขึ้นตู้ Container สำหรับรถจักรยานยนต์ พร้อมบันทึกหลักฐานตามขอบเขตงาน" },
    sections: [
      section("container-loading-hero", "HERO", "Container", "รับขึ้นตู้ Container และเตรียมส่งออก", "จัดเตรียมรถ วางแผนการจัดเรียง และดำเนินการขึ้นตู้ตามรายการงานจริง", { primaryLabel: "ขอใบเสนอราคา", primaryHref: "/quotation", secondaryLabel: "ดูผลงาน", secondaryHref: "/gallery" }),
      ...
      section("container-loading-gallery", "GALLERY", "ผลงานจริง", "ภาพการขึ้นตู้รถจักรยานยนต์", "ภาพจากการปฏิบัติงานจริงของบริษัท", { galleryLimit: 12 }),
  ...
  "dealer-fleet": {
    version: 1,
    seo: { title: "ขนส่งรถมอเตอร์ไซค์ Dealer และ Fleet | NATHEE GROUP 2025", description: "บริการขนส่งรถจักรยานยนต์สำหรับ Dealer, Fleet และงานล็อตใหญ่ พร้อมการวางแผนรับเข้า ขนส่ง และส่งมอบ" },
    sections: [
      section("dealer-fleet-hero", "HERO", "งานล็อต", "งาน Dealer, Fleet และงานล็อตใหญ่", "รองรับการวางแผนรถขนส่ง ลำดับรับ–ส่ง และข้อมูลรถจำนวนมากตามรายการที่ได้รับ", { primaryLabel: "ขอใบเสนอราคา", primaryHref: "/quotation", secondaryLabel: "ดูผลงาน", secondaryHref: "/gallery" }),
      ...
      section("dealer-fleet-gallery", "GALLERY", "ผลงานจริง", "ภาพงานล็อตและการจัดเตรียมรถ", "แสดงเฉพาะภาพจริงที่ได้รับอนุญาต", { galleryLimit: 12 }),
  ...
  quotation: {
    version: 1,
    seo: { title: "ขอใบเสนอราคาขนส่งรถจักรยานยนต์ | NATHEE GROUP 2025", description: "เตรียมข้อมูลต้นทาง ปลายทาง จำนวนรถ ประเภทรถ และวันที่ต้องการ เพื่อขอใบเสนอราคาจาก NATHEE GROUP 2025" },
    sections: [
