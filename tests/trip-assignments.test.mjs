...
function createDatabase({ capacity = 2 } = {}) {
  ...
  db.exec(`
    ...
    VALUES ('truck-a', '0198f708-44a3-7ef7-8d4f-4f477922aa01', 'truck-public-a', 'NG-01', 'SIX_WHEEL', ${capacity}, 'owner-a');
    INSERT INTO trips (id, request_key, public_id, trip_number, truck_id, origin, destination, created_by)
    VALUES
      ('trip-a', '0198f708-44a3-7ef7-8d4f-4f477922aa02', 'trip-public-a', 'TRIP-A', 'truck-a', 'A', 'B', 'owner-a'),
      ('trip-b', '0198f708-44a3-7ef7-8d4f-4f477922aa03', 'trip-public-b', 'TRIP-B', 'truck-a', 'A', 'C', 'owner-a');
  `);
  return db;
}
